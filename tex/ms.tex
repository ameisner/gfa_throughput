...
For this study, we use a series of 22 exposures. (RA, Dec) =  These exposures were chosen for the following reasons:
...
% mention "dense fields" program name
